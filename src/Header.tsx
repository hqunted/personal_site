          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="md:flex md:flex-wrap md:-mx-4 mt-6 md:mt-12">
              ...
              <div className="md:w-1/3 md:px-4 xl:px-6 mt-8 md:mt-0 text-center">
                ...
                <p className="text-gray-300">
                  Some cool shit about developing myself enormously through my
                  whole life
                </p>
              </div>
              ...
              <div className="md:w-1/3 md:px-4 xl:px-6 mt-8 md:mt-0 text-center">
                ...
                <p className="text-gray-300">
                  Open minded thing about stuff yea that is really cool that you
                  are open minded wow man thats insane but didnt ask!
                </p>
              </div>
            </div>
          </div>
